...
//      模块通道    端口          可选范围              建议
#define FTM0_CH0_PIN    PTC1        //PTC1、PTA3            PTA3不要用（与Jtag、SWD冲突）         右1
#define FTM0_CH1_PIN    PTA4        //PTC2、PTA4                                                 右2
#define FTM0_CH2_PIN    PTA5        //PTC3、PTA5                                                 左1
#define FTM0_CH3_PIN    PTA6        //PTC4、PTA6                                                 左2
