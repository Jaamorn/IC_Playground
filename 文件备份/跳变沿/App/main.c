...
*/
   ...
   {
     /*
        Display(leftbreak1,10,0);
        Display(rightbreak1,60,2);
        Display(leftlose1,10,4);
        //LCD_P6x8Str(10,4,"shizi");
        Display(direction_err,60,6);
        
      */  
        vcan_sendccd((uint8 *)&ccd1_array[0],TSL1401_SIZE);
