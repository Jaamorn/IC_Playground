...
{
  uint8 len_ahead_n = 0;                        //,len_ahead_1 = 5
  uint8 len_hinder_n = 128;                     //,len_hinder_1 = 123
  uint8 lossflag1_Left = 0;                     //,lossflag2_Left = 0
  uint8 lossflag1_Right = 0;                    //,lossflag2_Right = 0
  uint8 i = 0;
...
*/
    ...
    if (lossflag1_Left == 1)
  {
    ...
    else if (lossflag1_Right == 1)
  {
    lossline_Right = 1;
  }
    if (lossline_Left == 1 && lossline_Right == 1)
  {
    shizi = 1;
    lossline_Left = 0;
    lossline_Right = 0;
...
void CarDircAdjust(void)
{
  ...
  for(i=0;i<64;i++)
    ...
    else  if(zhijiao == 0&&(lossline_Left == 1||lossline_Right == 1))
    {
      for (k = 0;k<=2;k++)
      {
        sum+= predismid[k];
